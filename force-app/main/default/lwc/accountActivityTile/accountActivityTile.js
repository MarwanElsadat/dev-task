...
import getAccountActivitySummary from "@salesforce/apex/AccountActivityController.getAccountActivitySummary";
...
export default class AccountActivityTile extends NavigationMixin(
  LightningElement
) {
  @api recordId;
  ...
  wiredAccount() {
    /* no-op — used for cache reactivity */
  }
